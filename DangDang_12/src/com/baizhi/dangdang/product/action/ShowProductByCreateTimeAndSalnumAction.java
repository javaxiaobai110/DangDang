...
public class ShowProductByCreateTimeAndSalnumAction implements Action{

	@Override
	public String execute() throws Exception {
		ProductService service = new ProductServiceImpl();
		List<Dbook> list = service.getByCreateTimeAndSalnum();
		ValueStack vs = ActionContext.getContext().getValueStack();
		vs.setValue("#request.newandcreatelist", list);
		return "success";
	}
