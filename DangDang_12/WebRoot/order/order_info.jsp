	...
	<s:if test="#session.totalProductDdPrice == null || #session.totalProductDdPrice == 0.0">
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
				<s:iterator value="#session.map" status="c">
					<tr>
						<td valign="top">
						...
						<td valign="top">
							<s:property value="value.dbook.bookname"/>
						</td>
						<td valign="top">
							<s:property value="value.dbook.ddprice"/>
						</td>
						<td valign="top">
							<s:property value="value.count"/>
						</td>
						<td valign="top">
							<s:property value="value.ddPrice"/>
						</td>
					</tr>
				</s:iterator>
				...
				<tr>
					<td valign="top" class="w1" style="text-align: left" colspan="5">
						<b>总价：<s:property value="#session.totalProductDdPrice"/></b>
					</td>
				</tr>
			</table>
			<br />
