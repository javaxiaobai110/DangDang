...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<script type="text/javascript">
			$(function(){
				$("#Button1").click(function(){
					var v1 = $("#str1").text().trim();
					var v2 = $("#validatecode").val();
					if(v1 == v2){
						window.location.href = "${pageContext.request.contextPath}/user/activeCode?id="+v2;
					}else if(v2.length == 0){
						$("#errorMsg").html("激活码不能为空");
					}else{
						$("#errorMsg").html("非法的激活码");	
					}
				});
			});
		</script>
	...
	<body>
		<s:if test="#session.duserId == null">
				...
				<div class="look_email">
					...
					<div class="mess reduce_h">
						...
						<span class="red"><span id="lblEmail">
							<s:property value="#session.activeEmail"/>
						</span>
						</span>
						<span class="t1"> 
						请登录您的邮箱收信。
					...
					<h4>
						第二步：输入验证码 [<strong id="str1"><s:property value="#session.duserId"/></strong>]
					</h4>
					<div class="mess">
