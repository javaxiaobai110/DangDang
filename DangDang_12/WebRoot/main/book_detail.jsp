				...
				<DIV class=right_wai>
					<DIV class=shuming>
						<DIV class=shuming_left>
							<SPAN class=black000><A name=top_bk></A><s:property value="dbook.bookname"/></SPAN>
						</DIV>
						<DIV class=book_case>
							<SPAN class=seriesname>丛书名： <s:property value="dbook.bookname"/></SPAN>
						</DIV>
					...
					<DIV class=book_left>
						<DIV class=book_pic>
							<A
								...
								src="${pageContext.request.contextPath}<s:property value="dbook.src"/>"></A>
						</DIV>
						<INPUT id=hid_largepictureurl type=hidden>
					</DIV>
					<DIV class=book_right>
						<DIV id=author_>作 者： <s:property value="dbook.author"/></DIV>
						<DIV id=publisher_>出 版 社：<s:property value="dbook.edition"/></DIV>
						<UL>
							<LI>出版时间： <s:property value="dbook.printtime"/></LI>
							<LI>字 数： 1万</LI>
							<LI>版 次： 1</LI>
							<LI>页 数： 100</LI>
							<LI>印刷时间： 1970-1-1</LI>
						...
						<DIV class=jiage>
							<SPAN class=gray87>定价：<SPAN class=del id=originalPriceTag><s:property value="dbook.price"/></SPAN></SPAN>
							<SPAN class=redc30>当当价：￥<B><s:property value="dbook.ddprice"/></B></SPAN> 节省：￥<s:property value="dbook.price-dbook.ddprice"/>
							<DIV class=pd_buy_num>
								<DIV class=clear></DIV>
							</DIV>
							<DIV class=goumai>
								<A title=购买 href="${pageContext.request.contextPath}/cart/cartAdd?id=<s:property value="dbook.id"/>" name=purchase_book>
...
-->
					...
					<DIV id=__zhinengbiaozhu_bk>
						...
						<DIV class=zhengwen>上课头疼的故事</DIV>
						<DIV class=dashed></DIV>
						<H2 class=black14>
							<IMG src="../product_files/bg_point1.gif" align=absMiddle>
							作者简介
						</H2>
						<DIV class=zhengwen>我写的 作者是好人</DIV>
						<DIV class=dashed></DIV>
						<H2 class=black14>
							<IMG src="../product_files/bg_point1.gif" align=absMiddle>
							目录
